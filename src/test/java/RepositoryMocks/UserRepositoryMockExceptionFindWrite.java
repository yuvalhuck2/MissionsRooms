...
public class UserRepositoryMockExceptionFindWrite implements UserCrudRepository {
    private DataGenerator dataGenerator;

    public UserRepositoryMockExceptionFindWrite(DataGenerator dataGenerator) {
