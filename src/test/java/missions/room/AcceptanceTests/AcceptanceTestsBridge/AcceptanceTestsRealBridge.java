...
import DataObjects.FlatDataObjects.UserType;
...
//        this.userAuthenticationService = new UserAuthenticationService();
    ...
    public Boolean register(RegisterDetailsTest details) {
        return !userAuthenticationService.register(convertRegisterDetails(details)).getValue().isEmpty();
    }

    @Override
    public Boolean registerCode(String alias, String code) {
        return userAuthenticationService.registerCode(alias, code, null, null).getValue();
    }
