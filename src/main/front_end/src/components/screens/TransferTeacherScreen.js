...
import {transferClassroomChanged,transferGroupChanged,transferTeacher,handleBackTransfer}from '../../actions/ManageUsersActions';
import {TransferTeacherStrings} from '../../locale/locale_heb';
...
const {
    ...
    select_group,
    ok,
} = TransferTeacherStrings;

class TransferTeacherForm extends Component {
    constructor(...args) {
        super(...args);
    ...
    onButtonPress(){
        ...
        this.props.transferTeacher({apiKey:apiKey,alias:currUser.alias,classroomName:chosenClassroom,groupType:chosenGroup,navigation:navigation})
    }
...
const mapStateToProps = (state) => {
    const {  apiKey, loading,allClassrooms,chosenClassroom ,chosenGroup,currUser,errorMessage,profile} = state.manageUsers;
    return {  apiKey, loading,allClassrooms ,chosenClassroom ,chosenGroup,currUser,errorMessage,profile};
};
