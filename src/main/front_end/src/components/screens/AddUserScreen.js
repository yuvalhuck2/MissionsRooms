...
import { changeClassNumber, changeGrade, changeGroup,
  changeAlias, changeFirstName, changeLastName, changeSupervisor,
  addUser } from '../../actions/AddUserActions';
...
class AddUserForm extends Component{
    ...
    onButtonPress() {
      const {alias, firstName, lastName, grade, classNumber, classGroup,
        isStudent, isSupervisor, apiKey} = this.props;
        this.props.addUser({alias, firstName, lastName, grade, classNumber, classGroup,
      ...
      renderGroupsList(){
        ...
        return (
          <List.Accordion
            ...
            >
            <List.Item title={'A'}
              left={props => <List.Icon {...props} icon={this.renderIcon(classGroup == 'A')} />}
              onPress = {()=>this.onChangeGroup('A')}
              />
            <List.Item title={'B'}
              left={props => <List.Icon {...props} icon={this.renderIcon(classGroup == 'B')} />}
...
const mapStateToProps = (state) => {
    const { alias, firstName, lastName, grade, classNumber, classGroup,
      isStudent, isSupervisor, apiKey, loading, errorMessage } = state.addUser;
    return { alias, firstName, lastName, grade, classNumber, classGroup,
      isStudent, isSupervisor ,apiKey, loading, errorMessage };
  };
