...
import {
  downloadFile,
  responseAns,
} from "../../actions/WatchOpenAnswerActions";
import { theme } from "../../core/theme";
import { watchOpenSolution } from "../../locale/locale_heb";
...
class WatchOpenAnswerForm extends Component {
  ...
  renderApproveBtn() {
    return (
      <Button mode="contained" style={styles.button} onPress={this.onApprove}>
        {approve_ans}
      </Button>
    );
  }
  ...
  renderRejectBtn() {
    return (
      <Button mode="contained" style={styles.button} onPress={this.onReject}>
        {reject_ans}
      </Button>
    );
  }
  ...
  renderQuestion() {
    ...
    return [<Text>{question_title}</Text>, <Text>{question}</Text>];
  }
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <View style={styles.row_center}>{this.renderButton()}</View>
...
export default connect(mapStateToProps, { responseAns })(WatchOpenAnswerForm);
