...
public enum OpCode implements Serializable {
    ...
    FAILED_TO_SAVE_FILE, MISSION_NOT_IN_ROOM, INVALID_ANSWER, Negative_Points, Wrong_Details, Wrong_Group, Has_Students,
    NO_OPEN_ANSWER_FILE, FILE_SYS_ERROR, Has_Unapproved_Solutions, Trivia_Subject_Not_Exists
